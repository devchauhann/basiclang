...
const StudyLanding: React.FC<StudyLandingProps> = ({ onGetStarted }) => {
    ...
    const languages = [
        ...
        { name: 'CSS', icon: SiCss3, color: 'from-pink-400 to-rose-600' }
    ];
    ...
    return (
        <div className={`min-h-screen overflow-x-hidden transition-colors duration-300 selection:bg-pink-500 selection:text-white ${isDark ? 'bg-[rgb(27,27,31)]' : 'bg-white'}`}>
            {/* Hero Section */}
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-col lg:flex-row items-center gap-20 lg:gap-16">
                        ...
                        <div className="flex-1 space-y-8">
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-[-0.02em] leading-tight bg-clip-text text-transparent bg-gradient-to-br from-pink-500 via-pink-400 to-violet-600">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                                <button
                                    ...
                                    className="group px-9 sm:px-8 md:px-12 py-4 sm:py-5 md:py-5 bg-gradient-to-br from-pink-400 via-pink-500 to-violet-600 text-white font-black uppercase tracking-widest text-[10px] rounded-[2rem] shadow-[inset_-4px_-4px_8px_rgba(0,0,0,0.3),inset_4px_4px_8px_rgba(255,255,255,0.3),8px_8px_16px_rgba(0,0,0,0.15)] hover:scale-110 active:scale-95 transition-all flex items-center justify-center gap-2"
                                >
                                    Get Started
                        ...
                        <div className="flex-1 w-full">
                            <div className={`rounded-3xl p-8 backdrop-blur-sm ${isDark ? 'bg-white/5 border border-white/10' : 'bg-gray-100/50 border border-gray-200'}`}>
                                <div className="text-center">
                                    <Code2 className="w-24 h-24 mx-auto mb-6 text-pink-500" />
                            ...
                            return (
                                <div
                                    ...
                                    className={`p-8 rounded-2xl text-center transition-all hover:scale-105 cursor-pointer ${isDark
                                        ? 'bg-[rgb(32,33,39)] hover:shadow-pink-500/20'
                                        : 'bg-gray-50 hover:shadow-pink-500/20'
                                        }`}
                                >
                                    <div className="flex justify-center mb-3">
                                        <IconComponent size={48} color="#ec4899" />
                                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {features.map((f, i) => {
                            ...
                            return (
                                ...
                                >
                                    <Icon className="w-10 h-10 mb-6 text-pink-500" />
            ...
            <section className={`py-16 md:py-20 px-6 md:px-8 ${isDark ? 'bg-[rgb(32,33,39)]' : 'bg-gray-50'}`}>
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="text-center">
                            <div className="text-5xl font-black mb-3 bg-clip-text text-transparent bg-gradient-to-br from-pink-500 to-violet-600">
                                6+
                            </div>
                            <p className={`text-lg font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                        ...
                        {faqs.map((faq, i) => (
                            ...
                            >
                                <div className="p-6 flex items-center justify-between">
                                    ...
                                    <ChevronDown
                                        size={20}
                                        className={`transition-transform ${openFaq === i ? 'rotate-180' : ''} text-pink-500`}
                                    />
                                </div>
                                {openFaq === i && (
